...
import Orga from '@/public/images/orga.svg'
...
const testimonials: Testimonials[] = [
  ...
  // },
  {
    ...
    clientImg: Orga,
    name: 'Cyril H.',
    company: 'My Check Experience',
    content:
      'Le suivi personnalisé et les conseils stratégiques que nous avons reçus ont été précieux pour nous aider à atteindre nos objectifs numériques. Je recommande vivement leur expertise',
    categories: [1, 2, 4, 5],
  },
  // {
